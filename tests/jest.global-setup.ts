...
export default async () => {
    await Promise.all([
        createTestTable('TestUsers', [{ AttributeName: 'PK', KeyType: KeyType.HASH }, { AttributeName: 'SK', KeyType: KeyType.RANGE }], [{ AttributeName: 'PK', AttributeType: ScalarAttributeType.S }, { AttributeName: 'SK', AttributeType: ScalarAttributeType.S }, { AttributeName: 'email', AttributeType: ScalarAttributeType.S }, { AttributeName: 'EntityTypeGSI_PK', AttributeType: ScalarAttributeType.S }, { AttributeName: 'EntityTypeGSI_SK', AttributeType: ScalarAttributeType.S }], [{ IndexName: 'email-index', KeySchema: [{ AttributeName: 'email', KeyType: KeyType.HASH }], Projection: { ProjectionType: ProjectionType.ALL }, ProvisionedThroughput: { ReadCapacityUnits: 1, WriteCapacityUnits: 1 } }, { IndexName: 'EntityTypeGSI', KeySchema: [{ AttributeName: 'EntityTypeGSI_PK', KeyType: KeyType.HASH }, { AttributeName: 'EntityTypeGSI_SK', KeyType: KeyType.RANGE }], Projection: { ProjectionType: ProjectionType.ALL }, ProvisionedThroughput: { ReadCapacityUnits: 1, WriteCapacityUnits: 1 } }]),
