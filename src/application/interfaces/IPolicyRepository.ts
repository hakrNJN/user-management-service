...
export interface IPolicyRepository {
     ...
     */
    findById(tenantId: string, policyId: string): Promise<Policy | null>;
     ...
     * @returns A promise resolving to the Policy entity or null if not found.
     */
    findByName(tenantId: string, policyName: string): Promise<Policy | null>;
     ...
     */
    list(tenantId: string, options?: QueryOptions & { language?: string }): Promise<QueryResult<Policy>>;
     ...
     */
    delete(tenantId: string, policyId: string): Promise<boolean>;
     ...
     * @returns A promise resolving to the Policy entity or null if not found.
     */
    getPolicyVersion(tenantId: string, policyId: string, version: number): Promise<Policy | null>;
     ...
     */
    listPolicyVersions(tenantId: string, policyId: string): Promise<Policy[]>;

    /**
     * Retrieves all policies from the repository.
     * @returns A promise resolving to an array of all Policy entities.
     */
    getAllPolicies(tenantId: string): Promise<Policy[]>;
